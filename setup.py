...
#
# However, when we do this, we also import `pyk8sver/__init__.py'. If this
...
def _lint():
    ...
    retcode = subprocess.call(
        ['flake8', '--max-complexity=14'] + project_python_files)
    if retcode == 0:
...
setup_dict = dict(
    ...
    entry_points={
        #'console_scripts': [
        #    'pyk8sver_cli = pyk8sver.main:entry_point'
        #],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'pyk8sver_gui = pyk8sver.gui:entry_point'
        # ]
    }
)
